...
def test_get_meal_by_id(mock_cursor):
    # Simulate that the song exists (id = 1)
    mock_cursor.fetchone.return_value = (1, "Meal", "Cuisine", "Italian", "Price", False)

    # Call the function and check the result
    result = get_meal_by_id(1)

    # Expected result based on the simulated fetchone return value
    expected_result = Meal(1, "Meal", "Cusine", 12.5, "Price")
...
def test_get_meal_by_name(mock_cursor):
    ...
    mock_cursor.fetchone.return_value = (1, "Meal", "Cuisine", 22, "MED", False)

    # Call the function and check the result
    result = get_meal_by_name("Meal", "Cuisine", 14)

    # Expected result based on the simulated fetchone return value
    expected_result = Meal(1, "Meal", "Cuisine", 20, "MED")
    ...
    # Assert that the SQL query was executed with the correct arguments
    expected_arguments = ("Meal", "Cusiine", 20)
    assert actual_arguments == expected_arguments, f"The SQL query arguments did not match. Expected {expected_arguments}, got {actual_arguments}."
...
def test_get_leaderboard(mock_cursor):
    ...
    mock_cursor.fetchall.return_value = [
        (1, "Meal A", "Cuisine A", 20, "MED",  10, False),
        (2, "Meal B", "Cuisine B", 11, "HARD",  20, False),
        (3, "Meal C", "Cuisine C", 30, "LOW", 5, False)
    ]
    ...
    expected_result = [
        {"id": 1, "meal": "Meal A", "cuisine": "Cuisine A", "price": 20, "difficulty": "HARD", "leaderboard": 10},
        {"id": 2, "meal": "Meal B", "cuisine": "Cuisine B", "price": 20.1, "difficulty": "LOW", "leaderboard": 20},
        {"id": 3, "meal": "Meal C", "cuisine": "Cuisine C", "price": 20.2, "difficulty": "MED",  "leaderboard": 5}
    ]
